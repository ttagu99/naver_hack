...
def SEInceptionResNetV2(include_top=True,
    ...
    if weights == 'imagenet':
        temp = InceptionResNetV2(include_top = False, weights='imagenet', input_tensor=input_tensor,
                        input_shape=input_shape,
                        pooling=pooling)
        temp.save_weights('./inception_resnet_v2_weights_tf_dim_ordering_tf_kernels.h5')
        model.load_weights('./inception_resnet_v2_weights_tf_dim_ordering_tf_kernels.h5', by_name=True)
