...
if __name__ == '__main__':
    ...
    CONF_LIST.append({'name':'Xception', 'input_shape':(224, 224, 3), 'backbone':Xception
                    ...
                    , 'finetune_layer':70, 'fine_batchmul':15, 'fc_train_epoch':10, 'first_all_train_epoch':100})
    ...
    CONF_LIST.append({'name':'NASNetLarge', 'input_shape':(224, 224, 3), 'backbone':NASNetLarge
                    , 'batch_size':48 ,'fc_train_batch':260, 'SEED':111,'start_lr':0.0005
                    , 'finetune_layer':70, 'fine_batchmul':15, 'fc_train_epoch':10, 'first_all_train_epoch':100})
    ...
    first_all_train_epoch=CONF_LIST[SEL_CONF]['first_all_train_epoch']
    ...
    if config.mode == 'train':
        bTrainmode = True
        nsml.load(checkpoint='84', session='Zonber/ir_ph1_v2/188')
        nsml.save(0)